        ...
        <div className="hidden md:block md:w-[1546px] mb-24">
          <div className="font-[Ubuntu-Regular] text-base font-normal text-justify leading-[18px]">
            <div className="grid grid-cols-7 grid-row-6  gap-4">
              ...
              <img
                className="row-span-2 w-[200px] items-center"
                src={image1}
                alt="image01"
              />
              <p className="col-span-3 ">
              ...
              <img
                className="row-span-2 col-span-1 w-[200px] items-center"
                src={image3}
                alt="image03"
              />
              <img
                className="w-[200px] row-span-2 col-span-1 items-center"
                src={image4}
                alt="image04"
              />
              <p className="col-span-2 row-span-2">
              ...
              <img
                className="w-[200px] row-span-2 items-center"
                src={image5}
                alt="image05"
              />
              <p className="col-span-2 row-span-2">
              ...
              <p className="col-span-4 row-span-2">
